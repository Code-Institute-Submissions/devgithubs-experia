"""
Django settings for experia project.
...
CSRF_TRUSTED_ORIGINS = ['https://experia-app.herokuapp.com', 'https://8000-devgithubs-experia-5f6dfywraj0.ws-eu27.gitpod.io']
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket config
    AWS_STORAGE_BUCKET_NAME = 'experia'
...
# Add discount % or code VARS here.
# possibly DATE var to use as discount code at checkout.
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'experia@example.com'
else:
